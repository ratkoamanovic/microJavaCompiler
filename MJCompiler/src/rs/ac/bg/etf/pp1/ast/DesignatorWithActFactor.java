...
public class DesignatorWithActFactor extends Factor {

    private Designator Designator;
    private ActParsStartLeftParen ActParsStartLeftParen;
    private OptionalActPars OptionalActPars;

    public DesignatorWithActFactor (Designator Designator, ActParsStartLeftParen ActParsStartLeftParen, OptionalActPars OptionalActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorWithActFactor(\n");
